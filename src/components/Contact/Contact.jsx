...
Message: ${form.message}`;
  ...
  const whatsappURL = `https://wa.me/918791328156?text=${encodeURIComponent(text)}`;
                                ...
                                <div className='form-box'>
                                    <form onSubmit={handleSubmit}>
                                        <div className='form_inputs'>
                                            <input type="text" name="" onChange={handleChange} value={form.name} id="name" placeholder='Enter Name' />
                                        ...
                                        <div className='form_inputs'>
                                            <input type="number" onChange={handleChange} value={form.number} id="number" placeholder='Enter Number' />
                                            <span style={{color:'red'}}>{errors.number}</span>
                                        </div>
                                        <div className='form_inputs'>
                                          <textarea name="" id="message" onChange={handleChange} value={form.message} placeholder='Message' cols="30" rows="6"></textarea>
